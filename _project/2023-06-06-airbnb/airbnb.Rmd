...
**Abstract:** The proliferation of Airbnb rentals across cities is associated with amplifying economic and
housing inequalities, but few studies have investigated how a city’s structural and cultural
conditions are framed to prospective tourists on Airbnb’s online platform. Using topic modeling
on a public corpus of 19,967 Airbnb listings from Los Angeles, California located in 2,156
census block groups of which 1,316 (61%) were not majority white, I investigate how listings
differ in their descriptions based on neighborhood racial composition. I find that descriptions of
predominantly white neighborhoods focus on the physical and landscape aesthetics of the
neighborhood, whereas minority-majority neighborhoods include more details about residents as
well as the safety of the community. Language that deflects negative stereotypes about minority
neighborhoods is most explicit in descriptions of urban core neighborhoods where Black
residents are the majority or plurality. Overall, the findings suggest that the discursive
neighborhood marketing strategies in Airbnb’s online platform transmit existing urban
inequalities to prospective tourists by implicitly or explicitly engaging with stereotypes about
race and urban life.

<p> 
<a href="https://drive.google.com/file/d/1YJO0_l6bmpmG7KqyunKzEuOcw5hPSvt2/view?usp=sharing" style="margin-left: 3em"> <button class="btn btn-outline-dark"> <i class="fas fa-file-pdf fa-lg"></i> Paper</button> </a> 

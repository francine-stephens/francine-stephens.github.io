...
<p>
<a href="https://github.com/francine-stephens/Exercise/tree/main" style="margin-left: 1em"> <button class="btn btn-outline-dark"> <i class="fab fa-github fa-lg"></i> GitHub Repo</button> </a>
</p>

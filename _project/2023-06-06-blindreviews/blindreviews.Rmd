...
knitr::include_graphics("blind table.png")

```


```{r, echo=FALSE, fig.cap= "Monthly Review Frequency"}
knitr::include_graphics("Ratings_Change_Over_Time.png")

```

```{r, echo=FALSE, fig.cap= "Comparison of Ratings. Bolded ratings are statistically significantly different from Intuit's"}
knitr::include_graphics("statistical significance.png")
...
- **Scraping Functions:** These functions are imported into the execution script and can be seen below. <a href="https://github.com/francine-stephens/blind_reviews/blob/main/scalar_ratings_scraping_functions.R" style="margin-left: 1em"> <button class="btn btn-outline-dark"> <i class="fa-solid fa-code"></i> Code</button> </a> 
- **Executable Scraping Script:** <a href="https://github.com/francine-stephens/blind_reviews/blob/main/execute_blind_webscraper.Rmd" style="margin-left: 1em"> <button class="btn btn-outline-dark"> <i class="fa-solid fa-code"></i> Code</button> </a> 
...
```{r function code, file='scalar_ratings_scraping_functions.R', eval=FALSE}
```
